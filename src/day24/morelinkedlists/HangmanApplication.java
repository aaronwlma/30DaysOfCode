...
public class HangmanApplication {
	...
	public static void main(String[] args ) throws IOException {
		...
		System.out.println("Welcome to hangman! I will pick a word and "
				+ "you will try to guess it.\n  If you guess wrong 6 times, "
				+ "then I win.  If you can guess it before then, you win. \n "
				+ " Are you ready? I hope so because I am!");
		System.out.println();
		System.out.println("I have picked my word. Below is a picture, "
				+ "and below that is your current guess, which starts "
				+ "off as nothing. \n  Every time you guess incorrectly, I "
				+ "add a body part to the picture. \n  When there is a full "
				+ "person, you lose.");
		...
		while (doYouWantToPlay) {
			...
			// Play again or no?
			System.out.println();
			System.out.println("Do you want to play another game? Enter Y "
					+ "if you do.");
